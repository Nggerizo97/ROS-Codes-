...
class Move(object): # Se define la clase
    ...
    def moveSquare(self):
        # Move Forwards
        self.moveXTime(movingTime=3, linearSpeed=0.7, angularSpeed=0.0)
        # Turn
        self.moveXTime(movingTime=3, linearSpeed=0.0, angularSpeed=0.55)
...
if __name__ == '__main__':
    ...
    try:
        moveObject.moveSquare() # Se invoca la propiedad del provimiento programada dentro de la clase
